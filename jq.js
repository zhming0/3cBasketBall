...
(function(a, b) {
	...
	function      cq(a, b) {
		...
		cn = b} function co() {setTimeout(cp, 0);
			return cn = f.now()
		} function      cf() {
			try {
						...
						if (f.isArray(b))
							...
							if (!c && b != null && typeof b == "object")
								...
								if (a.type == = "checkbox" || a.type == = "radio")
									a.defaultChecked = a.checked} function bi(a) {return "getElementsByTagName" in a ? a.getElementsByTagName("*") : "querySelectorAll" in a ? a.querySelectorAll("*") :[]} function bh(a, b) {var c;
										if (b.nodeType == = 1) {
										...
										if (b.nodeType == = 1 && !!f.hasData(a)) {
											...
											return !a || !a.parentNode || a.parentNode.nodeType == = 11} function M(a, b) {return (a && a !== "*" ? a + "." : "") + b.replace(y, "`").replace(z, "&")} function L(a) {var b, c, d, e, g, h, i, j, k, l, m, n, o, p =[], q =[], r = f._data(this, "events");
...
if (!f.support.changeBubbles) {
	var             G,
	H = function(a) {var b = f.nodeName(a, "input") ? a.type : "", c = a.value;
